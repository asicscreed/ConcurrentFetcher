...
AbortSignal.timeout(m)]):this.abortManager.createSignal(t),...h};return this.fetchWithRetry(c,g,t,u,d,r,x,y,b).then(n=>{var q=Date.now();q={id:t,stamp:q};if(p)try{p(t,n,null,this.abortManager)}catch(z){console.log("Callback failed:",z)}else q.data=n;return Promise.resolve(q)}).catch(n=>{var q;const z=Date.now();k||(k=!0,this.firstErrorRaised={id:t,stamp:z,error:n,message:null!==(q=n.message)&&void 0!==q?q:"Error"});q={id:t,stamp:z};if(n instanceof SyntaxError||n.name&&"SyntaxError"===n.name)n=new B(n.message,
c);if(p)try{p(t,null,n,this.abortManager)}catch(E){console.log("Callback failed:",E)}else q.error=n;f&&this.abortAll();return Promise.reject(q)}).finally(()=>{e++;b&&!k&&b(t,e,this.requests.length,0,0)})});try{return await Promise.allSettled(a)}catch(g){throw k=!0,this.abortAll(),this.requests.forEach(l=>{var c,h;return null===(c=l.callback)||void 0===c?void 0:c.call(l,null!==(h=l.requestId)&&void 0!==h?h:"unknown",null,g,this.abortManager)}),g;}}async fetchTextStream(b,a,e,f,k,g){if(!b.body)throw Error("Response body is empty.");
...
"Argument is invalid: "+a;break;case "DuplicateKey":a="Duplicate key: "+a;break;case "ValueError":a="Value error: "+a}a=Error(a);a.name=b;return a}}w.AbortManager=C;w.ConcurrentFetcher=D;w.FetchError=A;w.JsonParseError=B;return w}({});
